...
# Метод __is_valid_sides - служебный, принимает неограниченное кол-во сторон, возвращает True если все стороны целые положительные
...
class Circle(Figure):
    ...
    def __init__(self, color: tuple[int, int, int], length, filled=False):
        ...
        self.__radius = length / (2 * 3.141569)

    def get_square(self):
        s = len(self) ** 2 / (4 * 3.141569)
        return s
